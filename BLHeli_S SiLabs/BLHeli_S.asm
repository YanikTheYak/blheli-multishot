...
ISEG AT 0D0h           
Temp_Storage:        DS  48    ; Temporary storage - Must fit all settings 
...
; ESC startup tone		
;----------------------------------------------------------		
;	Play start up tune - Configured in BLHeli-Configurator
; --------------------		
; 	
	Set_LED_0
	clr Flags3.MUTE
...
tune_end:
	pop ACC							; Reset stack
	jz OEM_Tones					; No notes were played - use OEM Tones
